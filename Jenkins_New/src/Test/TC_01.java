...
public class TC_01 {
	...
	public void TC_01() throws Exception{
		...
		System.out.println(Driver.driver.findElement(By.id(Driver.getLocators("Username"))).getAttribute("value"));
		Driver.driver.findElement(By.id(Driver.getLocators("PasswordTextBox"))).sendKeys(Driver.getLocators("Password"));
		System.out.println(Integer.valueOf(Driver.driver.findElement(By.id(Driver.getLocators("PasswordTextBox"))).getAttribute("value"))+1);
